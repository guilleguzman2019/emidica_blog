...
{
    public $shop, $product, $max, $size = NULL, $quantity = 1, $options = [];

    public function updatedSize()
    {
        $this -> max = $this -> product -> sizes -> where('id', $this -> size) -> first();
    }
    ...
    public function addItem()
    {
        ...
        $this -> options['size_id'] = $this -> size;
        $this -> options['size_name'] = $this -> max -> name;
    ...
    {
        return view('livewire.shop.product.add-cart-item-size');
    }
}
