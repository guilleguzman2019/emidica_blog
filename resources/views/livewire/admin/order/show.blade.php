<div class="p-4">
            ...
            <div class="bg-dark-2 p-4 border-dashed rounded-4 mb-4">
                ...
                <table class="table table-borderless text-white-50 fs-14 m-0">
                    ...
                    <tr class="border-bottom border-light border-opacity-10">
                        ...
                        <td class="text-end pe-0">{{ $order -> customer_email }}</td>
                    </tr>
                    <tr>
                        <td class="ps-0">
    ...
    @if ( $order -> comments )
        <div class="bg-dark-2 p-3 border-dashed rounded-4 mb-4">
            <span class="fs-16 fw-400">Comentarios:</span>
                                    ...
                                    <div>
                                        ...
                                        @if ( $item -> variation )
                                            ...
                                            @isset ( $variation['size'] )
                                                <span class="fs-12">Talle: {{ $variation['size'] }}</span><br>
                                            @endisset
                                            @isset ( $variation['color'] )
                                                <span class="fs-12">Color: <span class="d-inline-block ratio ratio-1x1 border rounded-circle position-relative" style="width: 16px; top: 3px; background: {{ $variation['color'] }}"></span>
                                            @endisset
                                        @endif
                                    </div>
                                </div>
