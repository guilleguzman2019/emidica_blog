					...
					<table border="0" cellspacing="0" cellpadding="0" width="600" style=" background: #fff" align="center">
						...
						<tr>
							<td style="padding: 30px 30px 0">
								<p style="font-weight: 600;">¡Hola {{ $order -> customer_name }}!</p>
								<p style="color: #666;">Acá está el resumen de tu pedido realizado el {{ $order -> created_at -> format('d/m/Y') }}.<br>
									También podés ver el detalle completo directamente en nuestra tienda haciendo <a href="{{ route('shop.order.show', [$order -> shop, $order -> token]) }}?mail">click aquí</a>. Ahí verás además las opciones de pago disponibles para procesar el pedido.
								</p>
								<p style="color: #666;">Pronto nos estaremos comunicando contigo informándote sobre la entrega de tu pedido.</p>
								<p style="color: #666; margin: 0;">¡Muchas gracias por tu compra!</p>
							</td>
						</tr>
						<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
									...
									<tbody>
										@foreach ($order -> products as $item)
											<tr valign="middle">
												<th style="border-bottom: 1px solid #EEE; padding-bottom: 10px; padding-top: 10px;" width="32">
												...
												<td style="border-bottom: 1px solid #EEE; padding-bottom: 10px; padding-top: 10px;" align="right">
					...
					<table border="0" cellspacing="0" cellpadding="0" width="600" align="center" style="padding-top: 15px;">
						<tr>
							<td style="color: #666; font-size: 11px; padding-right: 20px;">
								Este es un correo informativo por el pedido realizado en {{ url('/') }}/{{ $order -> shop -> slug }}. Si usted no realizó ningún pedido, desestímelo.
							</td>
