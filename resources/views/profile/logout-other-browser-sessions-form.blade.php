<div class="bg-dark-2 border-dashed rounded-4 mb-4 position-relative">
    <h2 class="fs-18 p-4 border-bottom border-light border-opacity-10">{{ __('Browser Sessions') }}</h2>

    <div class="p-4">
        <p class="text-white-50">{{ __('Manage and log out your active sessions on other browsers and devices.') }}</p>

        <x-jet-action-message on="loggedOut">
            {{ __('Done.') }}
        </x-jet-action-message>

        <div class="fs-14 text-white-50">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                <p class="fs-14 text-white-50">{{ __('Please enter your password to confirm you would like to log out of your other browser sessions across all of your devices.') }}</p>
